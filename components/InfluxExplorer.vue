<template>
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            ...
            <UButton icon="i-lucide-refresh-cw" variant="ghost" size="sm" :loading="isLoading" @click="exploreSchema">
                Explore Schema
            </UButton>
        </div>
        ...
        <div v-else class="space-y-4">
            <div v-for="measurement in measurements" :key="measurement.name" class="border rounded-lg p-4">
                ...
                <div v-if="measurement.fields.length > 0" class="mb-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <UBadge v-for="field in measurement.fields" :key="field" color="gray" variant="subtle"
                            size="sm">
                            {{ field }}
                        </UBadge>
                    </div>
                ...
                <div v-if="measurement.tagKeys.length > 0" class="mb-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <UBadge v-for="tag in measurement.tagKeys" :key="tag" color="blue" variant="subtle" size="sm">
                            {{ tag }}
                        </UBadge>
                    </div>
                </div>

                <UButton variant="outline" size="sm" @click="buildQueryForMeasurement(measurement.name)">
                    Build Query
                </UButton>
            </div>
        </div>
            ...
            <UCard>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <UInput v-model="queryBuilder.startTime" type="datetime-local"
                    ...
                    <div>
                        ...
                        <UInput v-model="queryBuilder.endTime" type="datetime-local"
                            @update:model-value="updateResolution" />
                    </div>
                    ...
                    <div>
                        ...
                        <UInput v-model.number="queryBuilder.resolution" type="number" :min="10" />
                    ...
                    <div class="bg-gray-50 rounded-md p-3">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <UButton icon="i-lucide-copy" variant="ghost" size="xs" @click="copyQuery(generatedQuery)">
                                Copy
                            </UButton>
                        </div>
                        <pre
            ...
            {{ generatedQuery }}</pre>
                    ...
                    <div v-if="queryResults !== null" class="bg-green-50 rounded-md p-3 border border-green-200">
                        ...
                        <div class="text-xs text-green-700 max-h-32 overflow-y-auto">
                            <pre class="whitespace-pre-wrap break-words">{{ JSON.stringify(queryResults.slice(0, 5), null, 2) }}{{
                ...
                <template #footer>
                    <div class="flex justify-end gap-2">
                        ...
                        <UButton icon="i-lucide-copy" variant="outline" @click="copyQuery(generatedQuery)">
                            Copy Query
                        </UButton>
                        <UButton icon="i-lucide-play" :loading="isTestingQuery" @click="testQuery">
                            Test Query
                        </UButton>
                    </div>
                </template>
