<template>
    <div class="passage-sidebar">
        <UAccordion type="multiple" :items="accordionItems" class="sidebar-accordion">
            <template #passages>
                <div class="accordion-content">
                    <PassageList :passages="passages" :selected-passage="selectedPassage" :is-loading="isLoading"
                        :error="error" @select="handlePassageSelect" />
                </div>
            </template>
            ...
            <template #layers>
                <div class="accordion-content">
                    <div class="sidebar-options">
                        ...
                        <label class="sidebar-option">
                            <input type="checkbox" :checked="layers.currents"
                                @change="updateLayer('currents', $event)" />
                            <span>Currents</span>
                        </label>
                        <label class="sidebar-option">
                            <input type="checkbox" :checked="layers.waypoints"
                                @change="updateLayer('waypoints', $event)" />
                            <span>Waypoints</span>
                        </label>
                        <label class="sidebar-option">
                            <input type="checkbox" :checked="layers.ais" @change="updateLayer('ais', $event)"
                                disabled />
                ...
                <div class="accordion-content">
                    <div class="sidebar-radio-group">
                        <label class="sidebar-radio-option">
                            <input type="radio" name="viewMode" value="clean" :checked="viewMode === 'clean'"
                                @change="updateViewMode('clean')" />
                            <span>Clean</span>
                        </label>
                        <label class="sidebar-radio-option">
                            <input type="radio" name="viewMode" value="analysis" :checked="viewMode === 'analysis'"
                                @change="updateViewMode('analysis')" />
                            <span>Analysis</span>
                        </label>
                        <label class="sidebar-radio-option">
                            <input type="radio" name="viewMode" value="playback" :checked="viewMode === 'playback'"
            ...
            <template #tools>
                <div class="accordion-content">
                    <div class="sidebar-actions">
                        <UButton variant="outline" size="sm" icon="i-lucide-download" class="sidebar-action-btn"
                            @click="exportGPX" @touchstart.prevent="exportGPX">
                            Export GPX
                        </UButton>
                        <UButton variant="outline" size="sm" icon="i-lucide-download" class="sidebar-action-btn"
                            @click="exportGeoJSON" @touchstart.prevent="exportGeoJSON">
                            Export GeoJSON
                        </UButton>
                        <UButton variant="outline" size="sm" icon="i-lucide-file-text" class="sidebar-action-btn"
                            @click="generateReport" @touchstart.prevent="generateReport">
                            Generate Report
                        </UButton>
                    </div>
                </div>
