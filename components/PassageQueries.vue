<template>
  <div class="space-y-4">
    ...
    <div
      v-else
      class="space-y-3 max-h-[600px] overflow-y-auto -mx-1 px-1"
    >
      <UCard
      ...
      >
        <div class="p-4">
          ...
          <div class="bg-gray-50 rounded-md p-3 mb-3">
            ...
            <pre
              class="text-xs font-mono text-gray-800 overflow-x-auto whitespace-pre-wrap break-words"
            >{{ query.query }}</pre>
          </div>
          ...
          <div v-if="query.parameters && Object.keys(query.parameters).length > 0" class="mt-3">
            <details class="text-sm">
              ...
              <div class="mt-2 pl-4 border-l-2 border-gray-200">
                <pre
                  class="text-xs font-mono text-gray-700 overflow-x-auto"
